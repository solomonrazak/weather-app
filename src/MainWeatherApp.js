...
function MainWeatherApp() {
  ...
  return (
    ...
    <div className="w-screen h-full bg-slate-300 min-h-screen">
      <h1
        className="text-4xl font-sans flex justify-center pt-10 font-bold"
        id="header"
      >
        Weather App
      </h1>
      <div className="container mx-auto flex flex-col space-y-12" id="content">
        ...
        {weatherData && 
        <div className="mx-auto flex flex-col bg-cover space-y-8 md:flex md:flex-row md:space-x-12" id="weather-info">
